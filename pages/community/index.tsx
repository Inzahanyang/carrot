...
import answer from "../api/community/[id]/answer";
        ...
        {data?.communities?.map((community) => (
          ...
          >
            ...
            <div className="mt-5 flex w-full items-center justify-between px-4 text-xs font-medium text-gray-500">
              ...
              <span>{new Date(community.updatedAt).toDateString()}</span>
            </div>
            <div className="mt-3 flex w-full space-x-5 border-t px-4 py-2.5   text-gray-700">
              <span className="flex items-center space-x-2 text-sm">
                ...
                <span>궁금해요 {community._count.wonders}</span>
              </span>
              <span className="flex items-center space-x-2 text-sm">
                <svg
                  className="h-4 w-4"
                ...
                <span>답변 {community._count.answers}</span>
              </span>
            </div>
          </Link>
        ))}
